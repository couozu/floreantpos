...
//	}
	...
	public void calculatePrice() {
		...
		setTotalAmount(NumberUtil.moneyRound(totalAmount));

		double dueAmount = totalAmount - getPaidAmount();
		setDueAmount(NumberUtil.moneyRound(dueAmount));
	}
	...
	private double calculateSubtotalAmount() {
		...
		return NumberUtil.moneyRound(subtotalAmount);
	}
	...
	private double calculateDiscountAmount() {
		...
		return NumberUtil.moneyRound(discountAmount);
	}
...
//		}
		...
		return NumberUtil.moneyRound(fixInvalidAmount(tax));
	}
	...
	public double calculateServiceCharge() {
		...
		return NumberUtil.moneyRound(fixInvalidAmount(serviceCharge));
	}
